-- Fixes an array-append ambiguity in the previous definition: `types || 'text'`
-- lets Postgres resolve the untyped literal as text[], which fails at runtime
-- with "malformed array literal". Every append of a bare literal is now cast.
